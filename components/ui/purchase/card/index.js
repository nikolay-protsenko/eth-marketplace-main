...
export default function Card({purchase, disabled, Footer, state}) {
  return (
    <div
      ...
      <div className="flex h-full">
        ...
        <div className="p-8 pb-4 flex-2">
          <div className="flex items-center">
            <div
              className="uppercase mr-2 tracking-wide text-sm text-blue-500 font-semibold">
              {purchase.type}
            </div>
            <div>
              { state === "activated" &&
          ...
          <Link href={`/purchases/${purchase.slug}`}>
            <a
          ...
          <p
            ...
            {purchase.description.substring(0, 70)}...
          </p>
          { Footer &&
            <div className="mt-2">
              <Footer />
