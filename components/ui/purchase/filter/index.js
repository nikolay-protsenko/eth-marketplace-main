...
export default function PurchaseFilter({onSearchSubmit, onFilterSelect}) {
    ...
    <div className="flex flex-col md:flex-row items-center my-4">
      <div className="flex mr-2 relative rounded-md">
        <input
          ...
          name="purchaseHash"
          id="purchaseHash"
          className="w-52 xs:w-96 focus:ring-blue-500 shadow-md focus:border-blue-500 block pl-7 p-4 sm:text-sm border-gray-300 rounded-md"
